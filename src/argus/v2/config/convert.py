    ...
    return {
        ...
        "roles": [
            ...
            {"name": "qa", "kind": "judge", "prompt":
             ...
             "unless the transcript records the access path, covered items, "
             "disposition for every covered report or item, verification "
             "evidence, and unresolved follow-up condition. Evidence basis: "
