        ...
        roles += [
            {
                ...
                "prompt": (
                    ...
                    "documents the access path, every covered report or item "
                    "with disposition, verification evidence, and unresolved "
            ...
            },
            {
                ...
                "prompt": (
                    ...
                    "access path, every covered report or item with "
                    "disposition, verification evidence, and unresolved "
                    "follow-up condition. "
