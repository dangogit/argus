...
_PIPELINE_CHECKPOINTS = (
    ...
    "- QA-sensitive work cannot close unless the transcript records the access "
    "path, every covered report or item's disposition, verification coverage "
    "and evidence, and unresolved follow-up. Evidence: "
