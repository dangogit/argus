...
_PIPELINE_CHECKPOINTS = (
    ...
    "- Before repair work, group recurring same-theme findings under one owner, "
    "one flow, and one smallest fix recommendation; evidence examples include "
    "duplicate tadam-agents gender-classification bug reports and repeated "
    "low-disk alerts.\n"
