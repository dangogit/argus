...
_PIPELINE_CHECKPOINTS = (
    ...
    "- Batch or corrective-work verdicts cannot close until every input item "
    "records its disposition, verification evidence, environment blocker or "
    "none, and unresolved follow-up or none.\n"
